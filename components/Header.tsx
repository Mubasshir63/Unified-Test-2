...
import { SearchIcon, NotificationIcon, AiAssistantIcon, MicrophoneIcon } from './icons/NavIcons';
    ...
    return (
        <header className="sticky top-0 z-20 flex items-center justify-between p-4 bg-white/80 backdrop-blur-sm border-b border-gray-200">
            ...
            <div className="flex items-center space-x-0 sm:space-x-1">
                 <button onClick={onVoiceAssistantClick} className="p-2 text-gray-600 hover:text-gray-900 transition-colors" aria-label="Open Voice Assistant">
                    <MicrophoneIcon />
                </button>
