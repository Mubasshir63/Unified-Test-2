// In a real application, this data would ideally be fetched from a dedicated API
// This is a representative subset of all states and districts in India.
...
export const LOCATION_COORDS: { [key: string]: { lat: number; lng: number } } = {
    // State Capitals & Major Cities
    "Port Blair": { lat: 11.6234, lng: 92.7265 }, // Andaman & Nicobar
    "Visakhapatnam": { lat: 17.6868, lng: 83.2185 }, // Andhra Pradesh
    "Itanagar": { lat: 27.0922, lng: 93.6053 }, // Arunachal Pradesh
    "Guwahati": { lat: 26.1445, lng: 91.7362 }, // Assam
    "Patna": { lat: 25.5941, lng: 85.1376 }, // Bihar
    "Chandigarh": { lat: 30.7333, lng: 76.7794 }, // Chandigarh
    "Raipur": { lat: 21.2514, lng: 81.6296 }, // Chhattisgarh
    "Daman": { lat: 20.4283, lng: 72.8397 }, // Dadra & Nagar Haveli and Daman & Diu
    "New Delhi": { lat: 28.6139, lng: 77.2090 }, // Delhi
    "Panaji": { lat: 15.4909, lng: 73.8278 }, // Goa
    "Gandhinagar": { lat: 23.2156, lng: 72.6369 }, // Gujarat
    "Ahmedabad": { lat: 23.0225, lng: 72.5714 },
    "Faridabad": { lat: 28.4089, lng: 77.3178 }, // Haryana
    "Gurugram": { lat: 28.4595, lng: 77.0266 },
    "Shimla": { lat: 31.1048, lng: 77.1734 }, // Himachal Pradesh
    "Srinagar": { lat: 34.0837, lng: 74.7973 }, // Jammu & Kashmir (Summer)
    "Jammu": { lat: 32.7266, lng: 74.8570 },   // Jammu & Kashmir (Winter)
    "Ranchi": { lat: 23.3441, lng: 85.3096 }, // Jharkhand
    "Bengaluru": { lat: 12.9716, lng: 77.5946 }, // Karnataka
    "Bengaluru Urban": { lat: 12.9716, lng: 77.5946 },
    "Mysuru": { lat: 12.2958, lng: 76.6394 },
    "Mangaluru": { lat: 12.9141, lng: 74.8560 },
    "Hubli": { lat: 15.3647, lng: 75.1240 },
    "Thiruvananthapuram": { lat: 8.5241, lng: 76.9366 }, // Kerala
    "Kochi": { lat: 9.9312, lng: 76.2673 },
    "Leh": { lat: 34.1526, lng: 77.5771 }, // Ladakh
    "Kavaratti": { lat: 10.5669, lng: 72.6417 }, // Lakshadweep
    "Bhopal": { lat: 23.2599, lng: 77.4126 }, // Madhya Pradesh
    "Indore": { lat: 22.7196, lng: 75.8577 },
    "Mumbai": { lat: 19.0760, lng: 72.8777 }, // Maharashtra
    "Mumbai City": { lat: 19.0760, lng: 72.8777 },
    "Mumbai Suburban": { lat: 19.0760, lng: 72.8777 },
    "Pune": { lat: 18.5204, lng: 73.8567 },
    "Nagpur": { lat: 21.1458, lng: 79.0882 },
    "Nashik": { lat: 19.9975, lng: 73.7898 },
    "Imphal": { lat: 24.8170, lng: 93.9368 }, // Manipur
    "Shillong": { lat: 25.5788, lng: 91.8933 }, // Meghalaya
    "Aizawl": { lat: 23.7367, lng: 92.7146 }, // Mizoram
    "Kohima": { lat: 25.6751, lng: 94.1026 }, // Nagaland
    "Bhubaneswar": { lat: 20.2961, lng: 85.8245 }, // Odisha
    "Puducherry": { lat: 11.9416, lng: 79.8083 }, // Puducherry
    "Ludhiana": { lat: 30.9010, lng: 75.8573 }, // Punjab
    "Amritsar": { lat: 31.6340, lng: 74.8723 },
    "Jaipur": { lat: 26.9124, lng: 75.7873 }, // Rajasthan
    "Jodhpur": { lat: 26.2389, lng: 73.0243 },
    "Udaipur": { lat: 24.5854, lng: 73.7125 },
    "Kota": { lat: 25.2138, lng: 75.8648 },
    "Gangtok": { lat: 27.3389, lng: 88.6065 }, // Sikkim
    "Chennai": { lat: 13.0827, lng: 80.2707 }, // Tamil Nadu
    "Coimbatore": { lat: 11.0168, lng: 76.9558 },
    "Madurai": { lat: 9.9252, lng: 78.1198 },
    "Tiruchirappalli": { lat: 10.7905, lng: 78.7047 },
    "Hyderabad": { lat: 17.3850, lng: 78.4867 }, // Telangana
    "Agartala": { lat: 23.8315, lng: 91.2868 }, // Tripura
    "Lucknow": { lat: 26.8467, lng: 80.9462 }, // Uttar Pradesh
    "Kanpur": { lat: 26.4499, lng: 80.3319 },
    "Kanpur Nagar": { lat: 26.4499, lng: 80.3319 },
    "Varanasi": { lat: 25.3176, lng: 82.9739 },
    "Agra": { lat: 27.1767, lng: 78.0081 },
    "Noida": { lat: 28.5355, lng: 77.3910 },
    "Gautam Buddh Nagar": { lat: 28.5355, lng: 77.3910 },
    "Dehradun": { lat: 30.3165, lng: 78.0322 }, // Uttarakhand
    "Kolkata": { lat: 22.5726, lng: 88.3639 }, // West Bengal
};